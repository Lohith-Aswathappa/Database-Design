...
public abstract class DType<T> {
    ...
    public static DType CreateDT(Literal value) {
        switch(value.type) {
            case TINYINT:
    ...
    public static DType createSystemDT(String value, byte dataType) {
        switch(dataType) {
    ...
    protected DType(int valueSerialCode, int nullSerialCode) {
