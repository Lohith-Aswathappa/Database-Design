...
public class TblQuery_Drop implements IQuery {

    public String databaseName;
    public String tableName;

    public TblQuery_Drop(String databaseName, String tableName) {
    ...
    public boolean ValidateQuery() {
        if(!Db_Helper.getDbHelper().tableExists(this.databaseName, this.tableName)){
