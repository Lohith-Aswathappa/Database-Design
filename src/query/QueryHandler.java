...
public class QueryHandler {
    ...
    static IQuery ShowTableListQueryHandler() {
        ...
        return new ShowTblQuery(QueryHandler.ActiveDatabaseName);
    }
    ...
    static IQuery DropTableQueryHandler(String tableName) {
        ...
        return new TblQuery_Drop(QueryHandler.ActiveDatabaseName, tableName);
    }
    ...
    static IQuery CreateTableQueryHandler(String tableName, String columnsPart) {
        ...
        query = new CreateTblQuery(QueryHandler.ActiveDatabaseName, tableName, columns, hasPrimaryKey);
        return query;
    }

    static IQuery DropDatabaseQueryHandler(String databaseName) {
        return new DbQuery_Drop(databaseName);
    }

    static IQuery ShowDatabasesQueryHandler() {
        return new ShowDbQuery();
    }
